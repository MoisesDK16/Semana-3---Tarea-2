...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-06-2024 a las 23:57:08
...
(39, 'gdf', 'dgf', 'dgf', 'gdf', 'gdf', 'dgf', 'gdf', 'dgf', 'dfg', 'dfggdf', '5453', 3, 100.00);
...
INSERT INTO `oficina` (`id_oficina`, `codigo_oficina`, `ciudad`, `pais`, `region`, `codigo_postal`, `telefono`, `linea_direccion1`, `linea_direccion2`) VALUES
...
(5, 'PAR-FR', 'Paris', 'Francia', 'EMEA', '75017', '+33 14 723 4404', '29 Rue Jouffroy d\'abbans', ''),
...
ALTER TABLE `empleado`
  ...
  ADD KEY `EMPLEADO_X_OFICINA` (`codigo_oficina`);
...
ALTER TABLE `oficina`
  ...
  ADD UNIQUE KEY `codigo_oficina` (`codigo_oficina`);
...
--
ALTER TABLE `cliente`
  MODIFY `codigo_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `empleado`
  ADD CONSTRAINT `EMPLEADO_X_OFICINA` FOREIGN KEY (`codigo_oficina`) REFERENCES `oficina` (`codigo_oficina`),
